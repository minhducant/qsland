...
export const Style: any = (props: Props) => {
  const PropsConvert = StyleSheet.flatten([
    props.bg && { backgroundColor: switchArrayValueFromData(props.bg, AppColor) },
    props.background && { backgroundColor: switchArrayValueFromData(props.background, AppColor) },
    ...
    //new
    props.borderR && { borderRadius: switchArrayValue(props.borderR) },
    props.borderC && { borderColor: switchArrayValue(props.borderC) },
    props.borderW && { borderWidth: switchArrayValue(props.borderW) },
    props.borderLW && { borderLeftWidth: switchArrayValue(props.borderLW) },
    props.borderTW && { borderTopWidth: switchArrayValue(props.borderTW) },
    props.borderRW && { borderRightWidth: switchArrayValue(props.borderRW) },
    props.borderBW && { borderBottomWidth: switchArrayValue(props.borderBW) },
    //new
  ...
  const PropsApp = StyleSheet.flatten([
    ...
    props.borderUpRadius && { borderTopLeftRadius: switchArrayValue(props.borderUpRadius), borderTopRightRadius: switchArrayValue(props.borderUpRadius) },
    props.borderDownRadius && { borderBottomLeftRadius: switchArrayValue(props.borderUpRadius), borderBottomRightRadius: switchArrayValue(props.borderUpRadius) },
    //
    ...
    props.gray && { backgroundColor: "gray" }, props.primary && { backgroundColor: "#4481EB" },
    //
...
const switchArrayValue = (value: any) => {
  if (isArray(value) && value.length > 0) return value[0]
  if (isString(value) || isNumber(value)) return value
  return undefined
}
// const checkProps = (name: string, prop: any, value: any = undefined) => {
//   if (prop) {
...
const switchArrayValueFromData = (value: any, ColorApp = AppColor) => {
  if (isArray(value) && value.length > 0) return ColorApp(value[0])
  if (isString(value) || isNumber(value)) return value
  return undefined
}