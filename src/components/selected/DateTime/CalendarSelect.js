...
class CalendarSelect extends Component {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          ...
          warpDayStyle,
          dateSelected
            ? {backgroundColor: '#2C1F23', ...dateSelectedWarpDayStyle}
            : {},
        ]}>
        <View>
          {renderChildDay(day)}
          <Text
            style={[
              ...
              dateSelected ? {...selectedDayStyle} : {},
              notCurrentMonth
                ? {color: '#493D40', ...notCurrentDayOfMonthStyle}
                : {},
            ]}>
            {day.split('-')[2]}
          </Text>
  ...
  render () {
    ...
    _.forEach(weekdays, element => {
      dayOfWeek.push(
        <Text key={element} style={[styles.weekdays, weekdayStyle]}>
          {element}
        </Text>,
      )
    })
        ...
        <View
          ...
          <TouchableOpacity onPress={() => this.yearMonthChange(-1, 'year')}>
            {renderPrevYearButton ? (
              ...
              <MCIcons name='chevron-double-left' size={30} color='#ff2121' />
            )}
          </TouchableOpacity>
          <TouchableOpacity onPress={() => this.yearMonthChange(-1, 'month')}>
            {renderPrevMonthButton ? (
              ...
              <MCIcons name='chevron-left' size={30} color='#ff2121' />
            )}
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => this.yearMonthChange(1, 'month')}>
            {renderNextYearButton ? (
              ...
              <MCIcons name='chevron-right' size={30} color='#ff2121' />
            )}
          </TouchableOpacity>
          <TouchableOpacity onPress={() => this.yearMonthChange(1, 'year')}>
            {renderNextMonthButton ? (
              ...
              <MCIcons name='chevron-double-right' size={30} color='#ff2121' />
            )}
          </TouchableOpacity>
        </View>
        <View
